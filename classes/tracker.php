        ...
        if ($this->outputmode == self::OUTPUT_CLI) {
            ...
            switch ($this->mode) {
                ...
                case tool_coursearchiver_processor::MODE_HIDE:
                    ...
                    $buffer->output(
                        '<h3>
                        ' . get_string('processhiding', 'tool_coursearchiver') . '
                        </h3>
                ...
                case tool_coursearchiver_processor::MODE_BACKUP:
                    ...
                    $buffer->output(
                        '<h3>
                        ' . get_string('processbackup', 'tool_coursearchiver') . '
                        </h3>
                        <div class="coursearchiver_progress_bar_spacing"></div>
                        <br />
                    ');
                ...
                case tool_coursearchiver_processor::MODE_ARCHIVE:
                    ...
                    $buffer->output(
                        '<h3>
                        ' . get_string('processarchiving', 'tool_coursearchiver') . '
                        </h3>
                        <div class="coursearchiver_progress_bar_spacing"></div>
                        <br />
                    ');
                ...
                case tool_coursearchiver_processor::MODE_DELETE:
                    ...
                    $buffer->output(
                        '<h3>
                        ' . get_string('processdeleting', 'tool_coursearchiver') . '
                        </h3>
                        <div class="coursearchiver_progress_bar_spacing"></div>
                        <br />
                    ');
                ...
                case tool_coursearchiver_processor::MODE_DELETEEMAIL:
                    ...
                    $buffer->output(
                        '<h3>
                        ' . get_string('processemailing', 'tool_coursearchiver') . '
                        </h3>
                        <div class="coursearchiver_progress_bar_spacing"></div>
                        <br />
                    ');
                ...
                case tool_coursearchiver_processor::MODE_OPTOUT:
                    ...
                    $buffer->output(
                        '<h3>
                        ' . get_string('processoptout', 'tool_coursearchiver') . '
                        </h3>
                        <div class="coursearchiver_progress_bar_spacing"></div>
                        <br />
                    ');
